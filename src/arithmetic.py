...
def generate_arithmetic() -> list:
    """
    The function generate_arithmetic is a function that is designed to make
    a random arithmetic problem that ensures the answer to the random
    problem is an integer. The function returns a list of length 4 that is
    in the format: [(printable arithmetic function), first num of arithmetic
    problem, arithmetic sign (+, -, *, /), second num of arithmetic problem]
    """
    sign = {0: "+", 1: "-", 2: "*", 3: "/"}
